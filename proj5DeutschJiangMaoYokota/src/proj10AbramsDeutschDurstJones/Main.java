...
public class Main extends Application {
    ...
    public void start(Stage stage) throws Exception {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/proj10AbramsDeutschDurstJones/resources/Main.fxml"));
        ...
        scene.getStylesheets().add(getClass().getResource(
                "/proj10AbramsDeutschDurstJones/resources/LightMode.css").toExternalForm());

        // configure the stage
        stage.setTitle("AbramsDeutschDurstJones's IDE");
        stage.sizeToScene();
        stage.setScene(scene);
        stage.setOnCloseRequest(event -> ((proj10AbramsDeutschDurstJones.Controller)
