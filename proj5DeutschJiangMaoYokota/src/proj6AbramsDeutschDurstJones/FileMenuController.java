...
public class FileMenuController {
     ...
     *
     * @param styledCodeArea StyledJavaCodeArea to compare with the the specified File
     * @param file File to compare with the the specified StyledJavaCodeArea
     * @return true if the content of the StyledJavaCodeArea matches the content of the File; false if not
     */
    public boolean fileContainsMatch(StyledJavaCodeArea styledCodeArea, File file) {
    ...
    public boolean tabNeedsSaving(Tab tab, boolean ifSaveEmptyFile) {
        StyledJavaCodeArea activeStyledCodeArea = (StyledJavaCodeArea)
                ((VirtualizedScrollPane) tab.getContent()).getContent();
    ...
    public boolean handleSaveAction(){
        ...
        // then the styled code area is saved to that file
            ...
            StyledJavaCodeArea activeStyledCodeArea = (StyledJavaCodeArea)((VirtualizedScrollPane)
                    selectedTab.getContent()).getContent();
            return this.setFileContents(activeStyledCodeArea.getText(), this.tabFileMap.get(selectedTab));
        }
    }
