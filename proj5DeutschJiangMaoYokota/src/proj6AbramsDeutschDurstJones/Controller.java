...
public class Controller {
    ...
    @FXML private void handleCompileButtonAction(Event event) {
        ...
        this.toolbarController.handleCompileButtonAction(event, this.tabFileMap.get(selectedTab));
    }
    ...
    @FXML private void handleCompileRunButtonAction(Event event) {
        Tab selectedTab = this.tabPane.getSelectionModel().getSelectedItem();
        this.toolbarController.handleCompileRunButtonAction(event, this.tabFileMap.get(selectedTab));
    }
